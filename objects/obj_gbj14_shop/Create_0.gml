...
//	{ name: "Throw",   price:   0, uses: -1, sprite: spr_gbj14_hud_item_throw  , sound: snd_gbj14_player_attack, script: "scr_gbj14_player_Use_Item_Lift"   , show_cursor: ""                               , description: "Throw objects" }
//	{ name: "Sword",   price:   0, uses: -1, sprite: spr_gbj14_hud_item_sword  , sound: snd_gbjam12_player_sword,script: "scr_gbj14_player_Use_Item_Sword"  , show_cursor: ""                               , description: "Slash foes and break brittle things." }
	{ name: "Shovel",  price:  10, uses: -1, sprite: spr_gbj14_hud_item_shovel , sound: snd_gbj14_player_attack, script: "scr_gbj14_player_Use_Item_Shovel" , show_cursor: "scr_gbj14_player_Cursor_Tool"   , description: "Can dig through sand and rocks." },
    { name: "Pickaxe", price: 300, uses: -1, sprite: spr_gbj14_hud_item_pick   , sound: snd_gbj14_player_attack, script: "scr_gbj14_player_Use_Item_Pick"   , show_cursor: "scr_gbj14_player_Cursor_Tool"   , description: "Can dig through bricks and stone." },
...
//  { name: "Springs", price: 500, uses: -1, sprite: spr_gbj14_hud_item_shoes  , sound: snd_gbj14_player_attack, script: ""                                 , show_cursor: ""                               , description: "Allows you to jump higher." },
    { name: "Box",	   price:  20, uses:  1, sprite: spr_gbj14_hud_item_box    , sound: snd_gbj14_player_attack, script: "scr_gbj14_player_Use_Item_Box"    , show_cursor: ""                               , description: "Lift and throw them." },
...
//  { name: "Musket",  price: 500, uses: 10, sprite: spr_gbj14_hud_item_musket , sound: snd_gbj14_player_attack, script: "scr_gbj14_player_Use_Item_Musket" , show_cursor: ""                               , description: "Can shoot at foes from afar." },
    { name: "Ankh",    price: 100, uses:  1, sprite: spr_gbj14_hud_item_ankh   , sound: snd_gbj14_player_attack, script: ""                                 , show_cursor: ""                               , description: "Revive after death once." },
];
shop_row_size = 3;
selected_item = 0;